...
class TKUnit:
    def __init__(self, name, ammo, life, direction):
        self.name = name
        self.ammo = str(ammo)
        self.life = str(life)
